...
const SignUpPage = () => {
    ...
    const {signInWithGoogle,signUpWithEmailAndPassword,UserLogined}=Firebase();

    const formSubmitClick=(e:any)=>{
        e.preventDefault();
  ...
  <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={formSubmitClick}>
                  <div>
                  ...
                  <div className='flex justify-center'>
                    <p className='text-[white] text-[18px] tracking-[3px]'>OR</p>
                  </div>
              ...
              >
              <button className='border border-[white] flex justify-center px-[8%] py-[3%] rounded-[8px]' >
                 <svg className="eUuXwBkW5W4__eatjSfd RRXFBumaW2SHdseZaWm6 _gmxfZ2BpOHxa6nWwqBB h-[25px]" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <p className='text-[white] ml-[10px]'> Sign up with Google</p>
                           

                 </button>
              <p className="text-sm font-light text-gray-500 dark:text-gray-400 text-center mt-[10px]">
